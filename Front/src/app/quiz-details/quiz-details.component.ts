...
export class QuizDetailsComponent implements OnInit {
  ...
  constructor(private quizservice:ClassroomService , private activateroute: ActivatedRoute, private fb: FormBuilder) { }
  id!: number;
  ngOnInit(): void {
  ...
  public test!: any;
  gettestbyid() {
    this.quizservice.afficherUneQuiz(this.id).subscribe(
      (response: any) => {
        this.test = response;
